...
function Home() {
  ...
  return (
    <div className='w-full min-h-[100vh] bg-[#f0efe7] pt-[100px] flex items-center lg:items-start justify-center gap-[20px] px-[20px] flex-col lg:flex-row relative pb-[50px]'>
      ...
      {uploadPost &&
        <div className='w-[90%] max-w-[500px] h-[400px] bg-white shadow-lg top-[100px] rounded-lg fixed z-[200] p-[20px] flex items-start justify-start flex-col gap-[20px]'>
          ...
          <textarea
            className='w-full h-[250px] outline-none border-none p-[10px] resize-none text-[19px]'
          ...
          <div className='flex justify-end items-center w-full'>
            <button
              className='w-[100px] h-[50px] rounded-full bg-[#24b2ff] mt-[20px] text-white'
              disabled={posting}
